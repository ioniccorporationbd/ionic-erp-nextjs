"use client";
const bannerImg = "/assets/erp/ionicerptrading.png";
                ...
                <div className="xl:col-span-4  md:col-span-3 bg-[#2c2a2a] text-white flex   flex-col  md:rounded-tl-xl md:rounded-tr-none rounded-t-xl  bannerWidth  
                  ">
                    ...
                    <div className="bannerHeading  md:p-7 p-5    ">
                        ...
                        <p className="pb-3 font-bold text-[#C8FF32] text-lg  2xl:mt-[10px]">আইওনিক ইআরপি- <span className="text-white">ট্রেডিং</span> </p>
...
<p className="text-[15px] xl:text-[18px] 2xl:text-[18px]  text-justify md:px-7 lg:w-auto px-5 z-10">
                        ...
                        আপনি যদি <span className="text-[#C8FF32]">ট্রেডিং </span> ব্যবসা জন্য ট্রেডিং এবং সংশ্লিষ্ট পণ্য <span className="text-[#C8FF32]">ট্রেডিং </span> ব্যবসায় থাকেন তবে সমস্ত জটিল ক্রিয়াকলাপ পরিচালনার জন্য আপনার ওয়ান স্টপ সমাধান হতে পারে <span className="text-[#C8FF32]">"আইওনিক ইআরপি" </span>  টোটাল সলুয়েশন ইআরপি সফ্টওয়ার। বিতরণ থেকে রপ্তানি পর্যন্ত <span className="text-[#C8FF32]">ট্রেডিং </span> ব্যবসা সাথে কাজ করার আমাদের অভিজ্ঞতা আপনাকে অপারেশনগুলিকে স্ট্রিমলাইন করতে, দক্ষতা উন্নত করতে এবং সামগ্রিক উত্পাদনশীলতা বাড়াতে সহায়তা করতে পারে।
                        </p>
...
<button className="pl-5 xl:pb-10 xl:pt-[55px] lg:pt-[70px]  md:pt-[65px] onurodhleft" onClick={() => window.dispatchEvent(new Event("open-contact-dialog"))}>  <p className="bg-[#C8FF32] text-[#001B41] rounded-full p-2 text-[16px] font-extrabold my-10 xl:my-3 px-5">
    অনুরোধ করুন
</p>
</button>
    </div>
                ...
                <div className=" xl:col-span-2 md:col-span-2 bg-black  text-white x p-7 md:rounded-tr-xl text-center md:text-start bannerRight">
                    ...
                    <div>
                        <p className="text-[20px] font-medium text-white text-center lg:pt-0 md:pt-[5px] xl:pt-[5px] 2xl:pt-[60px] ">
