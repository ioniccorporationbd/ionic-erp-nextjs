"use client";
const bannerImg = "/assets/erp/ionicerpagriculture.png";
    ...
    return (
      ...
      ">
        ...
        <div className="bannerHeading  md:p-7 p-5    ">
            ...
            <p className="pb-3 font-bold text-[#C8FF32] text-lg  2xl:mt-[10px]  ">আইওনিক ইআরপি - <span className="text-white">কৃষি</span></p>
...
<p className="text-[15px] xl:text-[18px] 2xl:text-[18px]  text-justify md:px-7 lg:w-auto px-5 z-10">
                        <span className="text-[#C8FF32]"> কৃষি</span> ব্যবস্থাপনায় <span className="text-[#C8FF32]">``আইওনিক ইআরপি`` </span>  বিজনেস ম্যানেজমেন্ট সফটওয়্যার ইআরপি সিস্টেম
                        </p>
                        <p className="text-[15px] xl:text-[18px] 2xl:text-[18px] pt-10  text-justify md:px-7 lg:w-auto px-5 z-10">

                        সেরা <span className="text-[#C8FF32]">``আইওনিক ইআরপি`` </span> বিজনেস ম্যানেজমেন্ট সফটওয়্যার সলিউশনের সাথে ডিজিটাল রূপান্তরের মাধ্যমে <span className="text-[#C8FF32]">কৃষির </span> চেহারা পরিবর্তন করা।
                        </p>
...
<button className="pl-5 2xl:pt-[93px] xl:pt-[120px]  md:pt-[75px] 2xl:pb-[25px] leftonurodhagriculture" onClick={() => window.dispatchEvent(new Event("open-contact-dialog"))}>  <p className="bg-[#C8FF32] text-[#001B41] rounded-full p-2 text-[16px] font-extrabold my-10 xl:my-3 px-5">
অনুরোধ করুন
</p>
</button>
</div>
