    ...
    return (
        ...
        <section>
            ...
            <ul className='list-disc pl-5 text-[#777777] text-[14.5px]pb-5'>
                ...
                <li>প্রতিটি গ্রাহক বা লিডের জন্য Facebook এর মতো টাইম লাইন বৈশিষ্ট্য আপনাকে একক পৃষ্ঠায় সমস্ত মেল বা ফোন কথোপকথন দেখতে দেয়।</li>
