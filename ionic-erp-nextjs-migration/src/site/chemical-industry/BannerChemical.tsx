...
// import bannerImg from '../assets/erp/ionicerpchemical.png'
const bannerImg = "/assets/erp/ionicerpchemical.png";
import { FaCheck } from "react-icons/fa";



const BannerChemical = () => {
    return (
        <div className="pt-36">
    ...
    <div className="xl:col-span-4  md:col-span-3 bg-[#2c2a2a] text-white flex   flex-col  md:rounded-tl-xl md:rounded-tr-none rounded-t-xl  bannerWidth  
      ">
        ...
        <div className="bannerHeading  md:p-7 p-5    ">
            ...
            <p className="pb-3 font-bold text-[#C8FF32] text-lg  2xl:mt-[10px]  ">আইওনিক ইআরপি - <span className="text-white">রাসায়নিক</span> </p>
        ...
        আপনি যদি  <span className="text-[#C8FF32]">রাসায়নিক</span> শিল্পের জন্য রাসায়নিক এবং সংশ্লিষ্ট পণ্য উৎপাদনের ব্যবসায় থাকেন তবে সমস্ত জটিল ক্রিয়াকলাপ পরিচালনার জন্য আপনার ওয়ান স্টপ সমাধান হতে পারে  <span className="text-[#C8FF32]">"আইওনিক ইআরপি"</span> টোটাল সলুয়েশন ইআরপি সফ্টওয়ার। উত্পাদন, বিতরণ থেকে রপ্তানি পর্যন্ত  <span className="text-[#C8FF32]">রাসায়নিক</span> শিল্পের সাথে কাজ করার আমাদের অভিজ্ঞতা আপনাকে অপারেশনগুলিকে স্ট্রিমলাইন করতে, দক্ষতা উন্নত করতে এবং সামগ্রিক উত্পাদনশীলতা বাড়াতে সহায়তা করতে পারে।
            </p>
...
<button className="pl-5 xl:pt-[25px] lg:pt-[70px]  md:pt-[45px] 2xl:pb-[25px] onurodhleftchemical" onClick={() => window.dispatchEvent(new Event("open-contact-dialog"))}>  <p className="bg-[#C8FF32] text-[#001B41] rounded-full p-2 text-[16px] font-extrabold my-10 xl:my-3 px-5">
অনুরোধ করুন
</p>
</button>
</div>
        ...
        <div className="relative flex justify-center   ">
            <img className="bannerimg 2xl:w-[280px] xl:w-[260px] w-[300px] xl:block   xl:absolute  md:hidden xl:-bottom-[30px] 2xl:-bottom-[6px] xl:right-0" src={bannerImg} alt="" />
        </div>
    </div>
    ...
    <div className=" xl:col-span-2 md:col-span-2 bg-black  text-white x p-7 md:rounded-tr-xl text-center md:text-start bannerRight">
        ...
        <div>
            <p className="text-[20px] font-medium text-white text-center lg:pt-0 md:pt-[5px] xl:pt-1 2xl:pt-[32px] onurodhrightmanufacture">
