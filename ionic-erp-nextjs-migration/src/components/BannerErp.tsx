"use client";
const bannerImg = "/assets/erp/bannererp.png";
        ...
        <div className="md:pt-36 pt-[120px]">
            ...
            <section className="grid xl:grid-cols-6  md:grid-cols-5  grid-cols-1  childBanner" >
                ...
                <div className="xl:col-span-4  md:col-span-3 bg-[#2c2a2a] text-white flex   flex-col  md:rounded-tl-xl md:rounded-tr-none rounded-t-xl  bannerWidth  
                  ">
                    ...
                    <div className="bannerHeading  md:p-7 p-5    ">
                        ...
                        <p className="pb-3 font-bold text-[#C8FF32] text-lg  2xl:mt-[10px]  ">আইওনিক ইআরপি</p>
                    ...
                    <div className=" xl:w-[60%] 2xl:w-[55%]   2xl:pt-7   bannerTExt">
                        ...
                        <p className="text-[15px] xl:text-[18px] 2xl:text-[18px]  text-justify md:px-7 lg:w-auto px-5 z-10">
                            ...
                            পাইথন প্রোগ্রামিং ভাষা হল শক্তিশালী এবং দ্রুত অন্যদের সাথে ভাল মিশতে পারে, সর্বত্র চলে বন্ধুত্বপূর্ণ এবং শেখা সহজ, ওপেন সোর্স।<span className="text-[#C8FF32]">"আইওনিক ইআরপি"</span>  বিজনেস ম্যানেজমেন্ট সফটওয়্যার- তৈরিতে ব্যবহার করা হয়েছে <span className="text-[#C8FF32]">"পাইথন প্রোগ্রামিং ভাষা"</span> । পাইথন সফটওয়্যার ফাউন্ডেশন হল পাইথন প্রোগ্রামিং ভাষার সাথে সম্পর্কিত ওপেন সোর্স প্রযুক্তির অগ্রগতির জন্য নিবেদিত একটি সংস্থা।
                        </p>
                        ...
                        <button className="pl-5 xl:pt-[75px] 2xl:pt-[25px] lg:pt-[90px]  md:pt-[70px] onurodhleft" onClick={() => window.dispatchEvent(new Event("open-contact-dialog"))}>  <p className="bg-[#C8FF32] text-[#001B41] rounded-full p-2 text-[16px] font-extrabold my-10 xl:my-3 px-5">
                            অনুরোধ করুন
                        </p>
                        </button>
                            </div>
                    ...
                    <div className="relative flex justify-center   ">
                        <img className="bannerimg 2xl:w-[280px] xl:w-[260px] w-[300px] xl:block   xl:absolute  md:hidden xl:-bottom-10 xl:right-0" src={bannerImg} alt="" />
                    </div>
                </div>
                ...
                <div className=" xl:col-span-2 md:col-span-2 bg-black  text-white x p-7 md:rounded-tr-xl text-center md:text-start bannerRight">
                    ...
                    <div>
                        <p className="text-[20px] font-medium text-white text-center lg:pt-0 md:pt-[5px] xl:pt-1 onurodhright">
